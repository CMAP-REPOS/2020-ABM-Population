...
popSimDir       <- "C:/Users/sbuchhorn/Desktop/cmap_wfh/abmupdate/newpop/abmpop"
validationDir   <- "C:/Users/sbuchhorn/Desktop/cmap_wfh/abmupdate/newpop/abmpop/validation"
...
columnMap       <- read.csv(paste(validationDir, "columnMap_CMAP.csv", sep = "/"))

seed_households <- read.csv("C:/Users/sbuchhorn/Desktop/cmap_wfh/abmupdate/newpop/abmpop/data/seedhh_2019_03172021.csv")
seed_col        <- c("PUMA", "hh_num", "WGTP")

expanded_hhid      <- read.csv(paste(popSimDir, "output/final_expanded_household_ids.csv", sep = "/"))
...
summary2           <- read.csv(paste(popSimDir, "output/final_summary_TAZ_PUMA.csv", sep = "/"))
summary3           <- read.csv(paste(popSimDir, "output/final_summary_TAZ.csv", sep = "/"))
summary4           <- read.csv(paste(popSimDir, "output/final_summary_MAZ.csv", sep = "/"))
...
uniformity <- seed_households[seed_households$WGTP>0, seed_col] %>%
  left_join(summary_hhid, by = c("hh_num" = "hh_id")) %>%
